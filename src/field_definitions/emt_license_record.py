...
class EmtLicenseRecordDict(BaseLicenseRecordDict):
    ...
    _FIELDS = ["Full Name", "License Number", "License Type", "License Status", "Issue Date", "Expiration Date"]
    ...
    _PROPERTY_NAMES = ["full_name", "license_number", "license_type", "license_status", "issue_date", "expiration_date"]
